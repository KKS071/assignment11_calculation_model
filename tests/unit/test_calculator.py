...
def test_add(a: Number, b: Number, expected: Number) -> None:
    result = add(a, b)
    assert result == expected, f"Expected add({a}, {b}) = {expected}, got {result}"
...
@pytest.mark.parametrize("a, b, expected", [
    ...
    "subtract_negative_float_by_positive_float",
    "subtract_positive_integer_from_zero",
])
def test_subtract(a: Number, b: Number, expected: Number) -> None:
    result = subtract(a, b)
    assert result == expected, f"Expected subtract({a}, {b}) = {expected}, got {result}"
...
@pytest.mark.parametrize("a, b, expected", [
    ...
    "multiply_negative_by_positive",
    "multiply_two_positive_floats",
    "multiply_negative_float_by_positive_float",
    "multiply_by_zero",
])
def test_multiply(a: Number, b: Number, expected: Number) -> None:
    result = multiply(a, b)
    assert result == expected, f"Expected multiply({a}, {b}) = {expected}, got {result}"
...
def test_divide(a: Number, b: Number, expected: float) -> None:
    result = divide(a, b)
    assert result == expected, f"Expected divide({a}, {b}) = {expected}, got {result}"
